...
namespace NursingChecklistManager.Controllers
{
    public class ChecklistLineItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ChecklistLineItemId,ActionToDo,Completed")] ChecklistLineItem checklistLineItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ChecklistLineItemId,ActionToDo,Completed")] ChecklistLineItem checklistLineItem)
        {
